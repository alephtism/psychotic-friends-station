...
<p align="center"> <img alt="Space Station 14" width="880" height="200" src="https://github.com/alephtism/psychotic-friends-station/blob/master/Resources/Textures/Logo/logo.png" /></p>

This is a fork from the primary repo for Funky Station (itself a fork of Goob Station) called Psychotic Friends Station,
made for me and my friend's servers after <b>The Roblox Chat Update</b> killed our Bremerton RP and forced us to move.
...
The Goob Station [docs site](https://docs.goobstation.com/) has documentation on GS14's content, engine, game design, and more. It's also the only documentation.

## Contributing

This is a closed fork for my friends, but if you wish to want to contribute anyway for any reason then shoot me a message.
I recommend you read the contribution guidelines. [Contribution Guidelines](https://docs.spacestation14.com/en/general-development/codebase-info/pull-request-guidelines.html)

## Building

We (and by we I mean Funky Station I didn't do shit) provide some scripts shown below to make the job easier.
